...
public class IntermediateQuizFragment extends Fragment {
    ...
    private void updateQuestion() {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("Intermediate_Quiz");
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(total>snapshot.getChildrenCount()){
                    ...
                    reference = FirebaseDatabase.getInstance().getReference().child("Intermediate_Quiz").child(String.valueOf(total));
